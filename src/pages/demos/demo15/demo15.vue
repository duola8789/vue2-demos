<template>
  <div class="score-resource clearfix">
    ...
    <div class="table-wrapper" v-if="tableReady">
      <!--表格-->
      <el-table class="resource-table" :data="result" :row-class-name="setClassName" empty-text="暂无数据" @expand-change="expandRow">
        <!--表格展开内容-->
            ...
            <el-table :data="props.row.children" :show-header="false" class="inner-table" empty-text="暂无数据">
              ...
              >
                <template slot-scope="scope">
                  <div v-html="formatters(column.formatter, scope.row, column, scope)"></div>
                </template>
              </el-table-column>
            </el-table>
          </template>
        ...
        >
          <template slot-scope="scope">
            <div v-html="formatters(column.formatter, scope.row, column)"></div>
          </template>
        </el-table-column>
      </el-table>
      <!--分页-->

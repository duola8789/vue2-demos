  ...
  <div>
    ...
    <p class="item">
      ...
      <label>
        ...
        <input v-else-if="times >= 2 && times < 5" :class="[times > 2 ? class5 : class4, class6]" type="email" placeholder="email" />
    ...
    <p class="item">
      ...
      <label>
        <input v-if="times < 2" :class="[times > 2 ? class5 : class4, class6]" type="text" placeholder="text" key="text" />
        <input
          v-else-if="times >= 2 && times < 5"

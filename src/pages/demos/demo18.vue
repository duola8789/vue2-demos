<template>
  <div class="container">
    ...
    <div class="intro">
      ...
      <p>
        声明组件可以通过单文件组件模板生产，也可以通过函数式的生成，参考
        <a href="https://cn.vuejs.org/v2/guide/render-function.html#函数式组件" target="_blank" rel="noopener noreferrer">官网</a>
      </p>
    </div>

    <MyCom></MyCom>
    <el-table :data="tableData" style="width: 100%; margin: 20px;">
      <el-table-column prop="date" label="日期" sortable width="180" :filter-method="filterHandler"></el-table-column>

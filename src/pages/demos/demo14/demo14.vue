<template>
  <div class="demo14-container">
    ...
    <div class="menu-container">
      <div class="left">
        <div @click="isCollapse = !isCollapse" class="menu-controller" :class="isCollapse ? '' : 'menu-controller-collapse'">
          <i v-if="!isCollapse" class="el-icon-d-arrow-left"></i>
          <i v-else class="el-icon-d-arrow-right"></i>
        </div>
        <el-menu :default-active="componentName" @select="handleSelect" :collapse="isCollapse" class="menu" :collapse-transition="true">
    ...
    <div class="menu-container">
      <div class="left">
        ...
        <el-menu default-active="Child1" :collapse="isCollapse" class="menu" :router="true" :collapse-transition="true">
          <el-menu-item index="Child1"><span>处理中心</span></el-menu-item>
          <el-menu-item index="Child2"><span>我的工作台</span></el-menu-item>
          <el-menu-item index="Child3"><span>订单管理</span></el-menu-item>
        </el-menu>
      </div>
